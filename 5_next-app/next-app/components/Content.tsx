...
const Content:React.FC<Props> = ({data,filters,changeTime,changeUser,recipeDelete, changeCategory}) => {
    ...
    return (
        ...
        <div className={style.main}>
            <aside className={style.aside}>
                ...
                <div className={style.search}>
                    <h5>レシピ分類で絞り込み</h5>
                    <RecipeCategory data={data} filters={filters} handleChangeCategory={handleChangeCategory}></RecipeCategory>
