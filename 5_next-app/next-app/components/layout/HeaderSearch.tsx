      ...
      <section className={searchStyles.c_search}>
        <fieldset className={searchStyles.c_search__field}>
          <form
            name='search_form'
            method='get'
            className={searchStyles.c_search__form}
            action='/search'
          >
            <div className={searchStyles.c_search__type_box}>
              <select
                name='type'
                id='type'
                className={searchStyles.c_search__type}
              >
            ...
            <input
              ...
              name='q'
              id='headerkeyword'
              className={searchStyles.c_search__input}
              autoComplete='off'
              placeholder='料理名・食材名・イベント名'
              itemProp='query-input'
            ></input>
            <button
              id='global-search-submit'
              className={searchStyles.c_search__button}
            >
              <i
                className={`${searchStyles.icon_search} iconSearch commonIcon`}
              ></i>
            </button>
          </form>
        </fieldset>
